...
public class DescribeTests {
    ...
    public void testInstall() {
        ...
        given()
                ...
                .body("install.typeElements[1].bindings[0].propertyBindings", hasSize(16))
                ...
                .body("install.typeElements[1].bindings[0].propertyBindings[13].databaseFieldName", equalTo("___sourceId"))
                .body("install.typeElements[1].bindings[0].propertyBindings[13].typeElementPropertyDeveloperName", equalTo("Source ID"))
                .body("install.typeElements[1].bindings[0].propertyBindings[14].databaseFieldName", equalTo("___filterCreatedDate"))
                .body("install.typeElements[1].bindings[0].propertyBindings[14].typeElementPropertyDeveloperName", equalTo("Filter: Created Date"))
                .body("install.typeElements[1].bindings[0].propertyBindings[15].databaseFieldName", equalTo("___filterUpdatedDate"))
                .body("install.typeElements[1].bindings[0].propertyBindings[15].typeElementPropertyDeveloperName", equalTo("Filter: Updated Date"))
                .body("install.typeElements[1].elementType", equalTo("TYPE"))
                .body("install.typeElements[1].properties", hasSize(16))
                ...
                .body("install.typeElements[1].properties[13].developerName", equalTo("Source ID"))
                .body("install.typeElements[1].properties[13].contentType", equalTo("ContentString"))
                .body("install.typeElements[1].properties[14].developerName", equalTo("Filter: Created Date"))
                .body("install.typeElements[1].properties[14].contentType", equalTo("ContentDateTime"))
                .body("install.typeElements[1].properties[15].developerName", equalTo("Filter: Updated Date"))
                .body("install.typeElements[1].properties[15].contentType", equalTo("ContentDateTime"))
