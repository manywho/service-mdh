...
public class DescribeTests {
    ...
    public void testInstall() {
        ...
        response
                ...
                .body("install.typeElements[2].bindings[1].propertyBindings[2].databaseFieldName", equalTo("sourceId"))
                ...
                .body("install.typeElements[2].bindings[1].propertyBindings[4].databaseFieldName", equalTo("createdDate"))
