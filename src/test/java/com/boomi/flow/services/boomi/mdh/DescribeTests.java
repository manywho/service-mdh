...
public class DescribeTests {
    ...
    public void testInstall() {
        ...
        response
                ...
                .body("install.typeElements[2].bindings[1].propertyBindings[3].databaseFieldName", equalTo("sourceEntityId"))
                .body("install.typeElements[2].bindings[1].propertyBindings[3].typeElementPropertyDeveloperName", equalTo("Source Entity ID"))
                ...
                .body("install.typeElements[2].properties[4].developerName", equalTo("Source Entity ID"))
